...
// tests for EcmDiscountWithRelations
void main() {
  // final instance = EcmDiscountWithRelations();

  group('test EcmDiscountWithRelations', () {
    // String id
    ...
    test('to test the property `minimumPurchaseAmount`', () async {
      // TODO
    });

    // List<String> applicableToSKUs (default value: const [])
    test('to test the property `applicableToSKUs`', () async {
      // TODO
    });
