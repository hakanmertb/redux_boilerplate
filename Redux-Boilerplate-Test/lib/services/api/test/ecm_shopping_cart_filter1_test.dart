...
// tests for EcmShoppingCartFilter1
void main() {
  // final instance = EcmShoppingCartFilter1();

  group('test EcmShoppingCartFilter1', () {
    // int offset
    ...
    // List<EcmShoppingCartIncludeFilterInner> include (default value: const [])
