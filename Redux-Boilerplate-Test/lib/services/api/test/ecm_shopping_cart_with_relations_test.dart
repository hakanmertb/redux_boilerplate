...
// tests for EcmShoppingCartWithRelations
void main() {
  // final instance = EcmShoppingCartWithRelations();

  group('test EcmShoppingCartWithRelations', () {
    // String id
    ...
    // List<EcmShoppingCartItemWithRelations> items (default value: const [])
