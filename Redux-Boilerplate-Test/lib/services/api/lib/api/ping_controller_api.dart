...
class PingControllerApi {
  PingControllerApi([ApiClient? apiClient]) : apiClient = apiClient ?? defaultApiClient;

  final ApiClient apiClient;

  /// Performs an HTTP 'GET /ping' operation and returns the [Response].
  Future<Response> pingControllerPingWithHttpInfo() async {
  ...
  Future<PingResponse?> pingControllerPing() async {
    final response = await pingControllerPingWithHttpInfo();
