...
class WorkflowManagementControllerApi {
  WorkflowManagementControllerApi([ApiClient? apiClient])
  ...
  Future<Response> workflowManagementControllerRunEventWithHttpInfo({
    RunEventRequestDTO? runEventRequestDTO,
  }) async {
  ...
  ///
  /// * [RunEventRequestDTO] runEventRequestDTO:
  Future<void> workflowManagementControllerRunEvent({
    RunEventRequestDTO? runEventRequestDTO,
  }) async {
    final response = await workflowManagementControllerRunEventWithHttpInfo(
      runEventRequestDTO: runEventRequestDTO,
    );
  ...
  Future<Response> workflowManagementControllerRunServiceSyncWithHttpInfo({
    RunServiceRequestDTO? runServiceRequestDTO,
  }) async {
    // ignore: prefer_const_declarations
    final path =
        r'/workflow-management/workflow-step-function-services/run-sync';
  ...
  ///
  /// * [RunServiceRequestDTO] runServiceRequestDTO:
  Future<dynamic> workflowManagementControllerRunServiceSync({
    RunServiceRequestDTO? runServiceRequestDTO,
  }) async {
    final response =
        await workflowManagementControllerRunServiceSyncWithHttpInfo(
      runServiceRequestDTO: runServiceRequestDTO,
    );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
  ...
  Future<Response>
      workflowManagementControllerRunStepFunctionAsyncWithHttpInfo({
    RunStepFunctionRequestDTO? runStepFunctionRequestDTO,
  }) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [RunStepFunctionRequestDTO] runStepFunctionRequestDTO:
  Future<void> workflowManagementControllerRunStepFunctionAsync({
    RunStepFunctionRequestDTO? runStepFunctionRequestDTO,
  }) async {
    final response =
        await workflowManagementControllerRunStepFunctionAsyncWithHttpInfo(
      runStepFunctionRequestDTO: runStepFunctionRequestDTO,
    );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
  ...
  ///
  /// * [RunStepFunctionRequestDTO] runStepFunctionRequestDTO:
  Future<Response> workflowManagementControllerRunStepFunctionSyncWithHttpInfo({
    RunStepFunctionRequestDTO? runStepFunctionRequestDTO,
  }) async {
    // ignore: prefer_const_declarations
  ...
  ///
  /// * [RunStepFunctionRequestDTO] runStepFunctionRequestDTO:
  Future<dynamic> workflowManagementControllerRunStepFunctionSync({
    RunStepFunctionRequestDTO? runStepFunctionRequestDTO,
  }) async {
    final response =
        await workflowManagementControllerRunStepFunctionSyncWithHttpInfo(
      runStepFunctionRequestDTO: runStepFunctionRequestDTO,
    );
    if (response.statusCode >= HttpStatus.badRequest) {
      throw ApiException(response.statusCode, await _decodeBodyBytes(response));
