...
class ParentPartial {
  /// Returns a new [ParentPartial] instance.
  ParentPartial({
    this.id,
    this.firstName,
    this.lastName,
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "ParentPartial[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "ParentPartial[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ParentPartial> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<ParentPartial>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ParentPartial.listFromJson(
          entry.value,
          growable: growable,
        );
      }
