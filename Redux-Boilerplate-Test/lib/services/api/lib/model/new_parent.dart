...
class NewParent {
  /// Returns a new [NewParent] instance.
  NewParent({
    this.firstName,
    this.lastName,
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "NewParent[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "NewParent[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<NewParent> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<NewParent>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = NewParent.listFromJson(
          entry.value,
          growable: growable,
        );
      }
