...
class EcmTransaction {
  /// Returns a new [EcmTransaction] instance.
  EcmTransaction({
    required this.id,
  ...
  @override
  String toString() => 'EcmTransaction[id=$id, userId=$userId, provider=$provider, amount=$amount, currency=$currency, paymentDate=$paymentDate, providerResponse=$providerResponse, description=$description, createdDate=$createdDate, createdBy=$createdBy, createdById=$createdById, updatedDate=$updatedDate, updatedBy=$updatedBy, updatedById=$updatedById, deletedDate=$deletedDate, deletedBy=$deletedBy, deletedById=$deletedById, isDeleted=$isDeleted, orderId=$orderId]';
