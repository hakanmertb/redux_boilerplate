...
class SearchWithRelations {
  /// Returns a new [SearchWithRelations] instance.
  SearchWithRelations({
    required this.id,
    this.zipCode,
    this.distance,
  ...
  static SearchWithRelations? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return SearchWithRelations(
        ...
        timeslots: SlotWithRelations.listFromJson(json[r'timeslots']),
