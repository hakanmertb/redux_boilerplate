...
class NewEcmDiscount {
  /// Returns a new [NewEcmDiscount] instance.
  NewEcmDiscount({
    required this.type,
    required this.value,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is NewEcmDiscount &&
    other.type == type &&
    other.value == value &&
  ...
  /// Returns a new [NewEcmDiscount] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static NewEcmDiscount? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "NewEcmDiscount[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "NewEcmDiscount[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return NewEcmDiscount(
  ...
  static List<NewEcmDiscount> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NewEcmDiscount>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = NewEcmDiscount.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, NewEcmDiscount> mapFromJson(dynamic json) {
    final map = <String, NewEcmDiscount>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = NewEcmDiscount.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of NewEcmDiscount-objects as value to a dart map
  static Map<String, List<NewEcmDiscount>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<NewEcmDiscount>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = NewEcmDiscount.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
