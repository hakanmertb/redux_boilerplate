...
class EcmAddressWithRelations {
  /// Returns a new [EcmAddressWithRelations] instance.
  EcmAddressWithRelations({
    required this.id,
    required this.type,
  ...
  @override
  String toString() => 'EcmAddressWithRelations[id=$id, type=$type, zipcode=$zipcode, country=$country, userId=$userId, street1=$street1, street2=$street2, city=$city, state=$state, contactPhone=$contactPhone, fullName=$fullName, createdDate=$createdDate, createdBy=$createdBy, createdById=$createdById, updatedDate=$updatedDate, updatedBy=$updatedBy, updatedById=$updatedById, deletedDate=$deletedDate, deletedBy=$deletedBy, deletedById=$deletedById, isDeleted=$isDeleted]';
