...
class SlotFieldsOneOf {
  /// Returns a new [SlotFieldsOneOf] instance.
  SlotFieldsOneOf({
    this.id,
    this.day,
    this.timeSlot,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SlotFieldsOneOf &&
    other.id == id &&
    other.day == day &&
  ...
  @override
  String toString() => 'SlotFieldsOneOf[id=$id, day=$day, timeSlot=$timeSlot, isAvailable=$isAvailable, parentId=$parentId, createdDate=$createdDate, createdBy=$createdBy, createdById=$createdById, updatedDate=$updatedDate, updatedBy=$updatedBy, updatedById=$updatedById, deletedDate=$deletedDate, deletedBy=$deletedBy, deletedById=$deletedById, isDeleted=$isDeleted, searchId=$searchId, providerId=$providerId, bookId=$bookId]';
  ...
  /// Returns a new [SlotFieldsOneOf] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SlotFieldsOneOf? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SlotFieldsOneOf[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SlotFieldsOneOf[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return SlotFieldsOneOf(
  ...
  static List<SlotFieldsOneOf> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SlotFieldsOneOf>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SlotFieldsOneOf.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SlotFieldsOneOf> mapFromJson(dynamic json) {
    final map = <String, SlotFieldsOneOf>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SlotFieldsOneOf.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SlotFieldsOneOf-objects as value to a dart map
  static Map<String, List<SlotFieldsOneOf>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SlotFieldsOneOf>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SlotFieldsOneOf.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
