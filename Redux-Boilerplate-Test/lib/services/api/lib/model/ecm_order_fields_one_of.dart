...
class EcmOrderFieldsOneOf {
  /// Returns a new [EcmOrderFieldsOneOf] instance.
  EcmOrderFieldsOneOf({
    this.id,
    this.userId,
    this.status,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EcmOrderFieldsOneOf &&
    other.id == id &&
    other.userId == userId &&
    other.status == status &&
  ...
  /// Returns a new [EcmOrderFieldsOneOf] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EcmOrderFieldsOneOf? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EcmOrderFieldsOneOf[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EcmOrderFieldsOneOf[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EcmOrderFieldsOneOf(
  ...
  static List<EcmOrderFieldsOneOf> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmOrderFieldsOneOf>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EcmOrderFieldsOneOf.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EcmOrderFieldsOneOf> mapFromJson(dynamic json) {
    final map = <String, EcmOrderFieldsOneOf>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EcmOrderFieldsOneOf.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EcmOrderFieldsOneOf-objects as value to a dart map
  static Map<String, List<EcmOrderFieldsOneOf>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EcmOrderFieldsOneOf>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EcmOrderFieldsOneOf.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
