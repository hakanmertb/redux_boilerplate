...
class EcmProductWithRelations {
  /// Returns a new [EcmProductWithRelations] instance.
  EcmProductWithRelations({
    required this.id,
    required this.name,
    required this.sku,
