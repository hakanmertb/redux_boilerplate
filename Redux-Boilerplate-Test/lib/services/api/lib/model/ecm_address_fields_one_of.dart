...
class EcmAddressFieldsOneOf {
  /// Returns a new [EcmAddressFieldsOneOf] instance.
  EcmAddressFieldsOneOf({
    this.id,
    this.type,
    this.street1,
    this.street2,
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EcmAddressFieldsOneOf &&
    other.id == id &&
    other.type == type &&
  ...
  /// Returns a new [EcmAddressFieldsOneOf] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EcmAddressFieldsOneOf? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EcmAddressFieldsOneOf[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EcmAddressFieldsOneOf[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EcmAddressFieldsOneOf(
  ...
  static List<EcmAddressFieldsOneOf> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmAddressFieldsOneOf>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EcmAddressFieldsOneOf.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EcmAddressFieldsOneOf> mapFromJson(dynamic json) {
    final map = <String, EcmAddressFieldsOneOf>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EcmAddressFieldsOneOf.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EcmAddressFieldsOneOf-objects as value to a dart map
  static Map<String, List<EcmAddressFieldsOneOf>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EcmAddressFieldsOneOf>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EcmAddressFieldsOneOf.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
