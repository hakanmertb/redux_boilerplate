...
class EcmDiscount {
  /// Returns a new [EcmDiscount] instance.
  EcmDiscount({
    required this.id,
    required this.type,
    required this.value,
