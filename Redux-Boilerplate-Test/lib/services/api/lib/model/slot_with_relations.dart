...
class SlotWithRelations {
  /// Returns a new [SlotWithRelations] instance.
  SlotWithRelations({
    required this.id,
    this.day,
    this.timeSlot,
