...
class EcmOrderWithRelations {
  /// Returns a new [EcmOrderWithRelations] instance.
  EcmOrderWithRelations({
    required this.id,
  ...
  static EcmOrderWithRelations? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return EcmOrderWithRelations(
        ...
        items: EcmOrderItemWithRelations.listFromJson(json[r'items']),
