...
class ParentWithRelations {
  /// Returns a new [ParentWithRelations] instance.
  ParentWithRelations({
    required this.id,
    this.firstName,
    this.lastName,
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "ParentWithRelations[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "ParentWithRelations[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ParentWithRelations> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<ParentWithRelations>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ParentWithRelations.listFromJson(
          entry.value,
          growable: growable,
        );
      }
