...
class ProviderPartial {
  /// Returns a new [ProviderPartial] instance.
  ProviderPartial({
    this.id,
    this.firstName,
    this.lastName,
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "ProviderPartial[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "ProviderPartial[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ProviderPartial> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<ProviderPartial>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = ProviderPartial.listFromJson(
          entry.value,
          growable: growable,
        );
      }
