...
class NewProvider {
  /// Returns a new [NewProvider] instance.
  NewProvider({
    this.firstName,
    this.lastName,
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key),
              'Required key "NewProvider[$key]" is missing from JSON.');
          assert(json[key] != null,
              'Required key "NewProvider[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<NewProvider> listFromJson(
    dynamic json, {
    bool growable = false,
  }) {
  ...
  static Map<String, List<NewProvider>> mapListFromJson(
    dynamic json, {
    bool growable = false,
  }) {
    ...
    if (json is Map && json.isNotEmpty) {
      ...
      for (final entry in json.entries) {
        map[entry.key] = NewProvider.listFromJson(
          entry.value,
          growable: growable,
        );
      }
