...
// tests for EcmTransactionFilter1
void main() {
  // final instance = EcmTransactionFilter1();

  group('test EcmTransactionFilter1', () {
    // int offset
    ...
    // List<EcmTransactionIncludeFilterInner> include (default value: const [])
