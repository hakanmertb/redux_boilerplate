...
// tests for EcmOrderWithRelations
void main() {
  // final instance = EcmOrderWithRelations();

  group('test EcmOrderWithRelations', () {
    // String id
    ...
    test('to test the property `shoppingCartId`', () async {
      // TODO
    });

    // List<EcmOrderItemWithRelations> items (default value: const [])
    test('to test the property `items`', () async {
      // TODO
    });

    // EcmShoppingCartWithRelations shoppingCart
    test('to test the property `shoppingCart`', () async {
      // TODO
    });
