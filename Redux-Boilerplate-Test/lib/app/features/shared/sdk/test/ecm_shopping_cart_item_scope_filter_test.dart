...
// tests for EcmShoppingCartItemScopeFilter
void main() {
  // final instance = EcmShoppingCartItemScopeFilter();

  group('test EcmShoppingCartItemScopeFilter', () {
    // int offset
    ...
    // List<Map<String, Object>> include (default value: const [])
