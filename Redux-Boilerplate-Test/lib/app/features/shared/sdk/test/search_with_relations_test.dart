...
// tests for SearchWithRelations
void main() {
  // final instance = SearchWithRelations();

  group('test SearchWithRelations', () {
    // String id
    ...
    // String ageOfLearner
    test('to test the property `ageOfLearner`', () async {
      // TODO
    });

    // String availabilityDate
    test('to test the property `availabilityDate`', () async {
      // TODO
    });
    ...
    // List<SlotWithRelations> timeslots (default value: const [])
