...
// tests for BlogFieldsOneOf
void main() {
  // final instance = BlogFieldsOneOf();

  group('test BlogFieldsOneOf', () {
    // bool id
    ...
    test('to test the property `additionalImage`', () async {
      // TODO
    });
    ...
    // bool thumbnailImage
    test('to test the property `thumbnailImage`', () async {
      // TODO
    });

    // bool bannerImage
    test('to test the property `bannerImage`', () async {
      // TODO
    });
