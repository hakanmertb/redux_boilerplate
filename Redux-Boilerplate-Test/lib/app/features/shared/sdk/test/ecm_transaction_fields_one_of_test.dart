...
// tests for EcmTransactionFieldsOneOf
void main() {
  // final instance = EcmTransactionFieldsOneOf();

  group('test EcmTransactionFieldsOneOf', () {
    // bool id
    ...
    test('to test the property `providerResponse`', () async {
      // TODO
    });
