...
// tests for ReviewWithRelations
void main() {
  // final instance = ReviewWithRelations();

  group('test ReviewWithRelations', () {
    // String id
    ...
    // num dislikeCount
    test('to test the property `dislikeCount`', () async {
      // TODO
    });

    // String replyText
    test('to test the property `replyText`', () async {
      // TODO
    });
