...
// tests for EcmOrderItemFilter1
void main() {
  // final instance = EcmOrderItemFilter1();

  group('test EcmOrderItemFilter1', () {
    // int offset
    ...
    // List<EcmOrderItemIncludeFilterInner> include (default value: const [])
