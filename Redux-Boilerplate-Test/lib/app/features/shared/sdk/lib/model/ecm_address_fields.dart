...
class EcmAddressFields {
  EcmAddressFields(  {  required this.id,    required this.type,    required this.street1,    required this.street2,    required this.city,    required this.state,    required this.zipcode,    required this.country,    required this.contactPhone,    required this.fullName,    required this.userId,    required this.createdDate,    required this.createdBy,    required this.createdById,    required this.updatedDate,    required this.updatedBy,    required this.updatedById,    required this.deletedDate,    required this.deletedBy,    required this.deletedById,    required this.isDeleted } );
  ///
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EcmAddressFields&&
    other.id == id&&
    other.type == type&&
  ...
  /// Returns a new [EcmAddressFields] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EcmAddressFields? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EcmAddressFields[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EcmAddressFields[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EcmAddressFields(
        id: mapValueOfType<bool>(json, r'id'),
        type: mapValueOfType<bool>(json, r'type'),
        street1: mapValueOfType<bool>(json, r'street1'),
        street2: mapValueOfType<bool>(json, r'street2'),
        city: mapValueOfType<bool>(json, r'city'),
        ...
        contactPhone: mapValueOfType<bool>(json, r'contactPhone'),
        fullName: mapValueOfType<bool>(json, r'fullName'),
  ...
  static List<EcmAddressFields> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmAddressFields>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EcmAddressFields.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EcmAddressFields> mapFromJson(dynamic json) {
    final map = <String, EcmAddressFields>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EcmAddressFields.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EcmAddressFields-objects as value to a dart map
  static Map<String, List<EcmAddressFields>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EcmAddressFields>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EcmAddressFields.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension EcmAddressFieldsJsonUtils on EcmAddressFields{
static List<EcmAddressFields> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmAddressFields>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
