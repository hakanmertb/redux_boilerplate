...
class ContactFilter1 {
  ContactFilter1(  {  required this.offset,    required this.limit,    required this.skip,    required this.order,    required this.where,    required this.fields,    required this.include } );
  ///
...
extension ContactFilter1JsonUtils on ContactFilter1{
static List<ContactFilter1> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ContactFilter1>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
