...
class EcmShoppingCartItemWithRelations {
  EcmShoppingCartItemWithRelations(  {  required this.id,    required this.quantity,    required this.createdDate,    required this.createdBy,    required this.createdById,     this.updatedDate,     this.updatedBy,     this.updatedById,     this.deletedDate,     this.deletedBy,     this.deletedById,    required this.isDeleted,    required this.shoppingCartId,    required this.productId,    required this.shoppingCart,    required this.product } );
  String id;
...
extension EcmShoppingCartItemWithRelationsJsonUtils on EcmShoppingCartItemWithRelations{
static List<EcmShoppingCartItemWithRelations> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmShoppingCartItemWithRelations>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
