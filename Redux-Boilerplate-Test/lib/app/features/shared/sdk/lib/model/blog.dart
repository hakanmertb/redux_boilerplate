...
extension BlogJsonUtils on Blog{
static List<Blog> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Blog>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
