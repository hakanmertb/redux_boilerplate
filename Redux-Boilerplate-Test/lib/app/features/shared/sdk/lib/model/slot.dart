...
class Slot {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is Slot&&
    other.id == id&&
    other.day == day&&
  ...
  @override
  String toString() => 'Slot[id=$id, day=$day, timeSlot=$timeSlot, isAvailable=$isAvailable, parentId=$parentId, createdDate=$createdDate, createdBy=$createdBy, createdById=$createdById, updatedDate=$updatedDate, updatedBy=$updatedBy, updatedById=$updatedById, deletedDate=$deletedDate, deletedBy=$deletedBy, deletedById=$deletedById, isDeleted=$isDeleted, searchId=$searchId, providerId=$providerId, bookId=$bookId]';
  ...
  /// Returns a new [Slot] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static Slot? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "Slot[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "Slot[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<Slot> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Slot>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = Slot.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, Slot> mapFromJson(dynamic json) {
    final map = <String, Slot>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = Slot.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  static Map<String, List<Slot>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<Slot>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = Slot.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension SlotJsonUtils on Slot{
static List<Slot> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Slot>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
