...
class SlotScopeFilterFields {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SlotScopeFilterFields;
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SlotScopeFilterFields[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SlotScopeFilterFields[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SlotScopeFilterFields> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<SlotScopeFilterFields>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SlotScopeFilterFields>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SlotScopeFilterFields.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension SlotScopeFilterFieldsJsonUtils on SlotScopeFilterFields{
static List<SlotScopeFilterFields> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SlotScopeFilterFields>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
