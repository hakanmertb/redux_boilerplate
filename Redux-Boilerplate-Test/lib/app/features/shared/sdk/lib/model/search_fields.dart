...
class SearchFields {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SearchFields&&
    other.id == id&&
  ...
  /// Returns a new [SearchFields] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SearchFields? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SearchFields[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SearchFields[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SearchFields> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SearchFields>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SearchFields.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SearchFields> mapFromJson(dynamic json) {
    final map = <String, SearchFields>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SearchFields.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SearchFields-objects as value to a dart map
  static Map<String, List<SearchFields>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SearchFields>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SearchFields.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension SearchFieldsJsonUtils on SearchFields{
static List<SearchFields> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SearchFields>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
