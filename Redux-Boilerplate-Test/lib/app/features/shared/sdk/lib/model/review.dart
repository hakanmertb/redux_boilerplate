...
class Review {
  ...
  @override
  String toString() => 'Review[id=$id, rate=$rate, review=$review, likeCount=$likeCount, dislikeCount=$dislikeCount, replyText=$replyText, email=$email, name=$name, parentId=$parentId, createdDate=$createdDate, createdBy=$createdBy, createdById=$createdById, updatedDate=$updatedDate, updatedBy=$updatedBy, updatedById=$updatedById, deletedDate=$deletedDate, deletedBy=$deletedBy, deletedById=$deletedById, isDeleted=$isDeleted, providerId=$providerId, userId=$userId]';
...
extension ReviewJsonUtils on Review{
static List<Review> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Review>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
