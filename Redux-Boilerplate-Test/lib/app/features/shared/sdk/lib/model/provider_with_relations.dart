...
class ProviderWithRelations {
  ProviderWithRelations(  {  required this.id,    required this.firstName,    required this.lastName,    required this.profileImageUrl,    required this.shortBio,    required this.longBio,    required this.email,    required this.mobilePhone,    required this.workPhone,    required this.supportedZipCodes,    required this.supportedAgeOfLearners,    required this.distance,    required this.hourlyRate,    required this.yearsOfExperience,    required this.teaches,    required this.specialties,    required this.acceptingStudents,    required this.createdDate,    required this.createdBy,    required this.createdById,     this.updatedDate,     this.updatedBy,     this.updatedById,     this.deletedDate,     this.deletedBy,     this.deletedById,    required this.isDeleted,    required this.reviews,    required this.providerAvailability } );
  String id;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ProviderWithRelations&&
    other.id == id&&
    ...
    _deepEquality.equals(other.providerAvailability, providerAvailability);
    ...
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ProviderWithRelations[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ProviderWithRelations[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return ProviderWithRelations(
        ...
        reviews: ReviewWithRelationsJsonUtils.listFromJson(json[r'reviews']),
        providerAvailability: SlotWithRelationsJsonUtils.listFromJson(json[r'providerAvailability']),
      );
    }
    return null;
  }

  static List<ProviderWithRelations> listFromJson(dynamic json, {bool growable = false,}) {
  ...
  static Map<String, List<ProviderWithRelations>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ProviderWithRelations>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ProviderWithRelations.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension ProviderWithRelationsJsonUtils on ProviderWithRelations{
static List<ProviderWithRelations> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ProviderWithRelations>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
