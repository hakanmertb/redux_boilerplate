...
class ParentFields {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ParentFields&&
    other.id == id&&
  ...
  /// Returns a new [ParentFields] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ParentFields? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ParentFields[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ParentFields[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ParentFields> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ParentFields>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ParentFields.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ParentFields> mapFromJson(dynamic json) {
    final map = <String, ParentFields>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ParentFields.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ParentFields-objects as value to a dart map
  static Map<String, List<ParentFields>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ParentFields>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ParentFields.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension ParentFieldsJsonUtils on ParentFields{
static List<ParentFields> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ParentFields>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
