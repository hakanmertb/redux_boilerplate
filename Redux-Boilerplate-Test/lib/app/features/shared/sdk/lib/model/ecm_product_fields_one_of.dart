...
class EcmProductFieldsOneOf {
  EcmProductFieldsOneOf(  {  required this.id,    required this.name,    required this.description,    required this.sku,    required this.thumbnailImageURL,    required this.imageURLs,    required this.price,    required this.manufacturer,    required this.supplier,    required this.stockQuantity,    required this.createdDate,    required this.createdBy,    required this.createdById,    required this.updatedDate,    required this.updatedBy,    required this.updatedById,    required this.deletedDate,    required this.deletedBy,    required this.deletedById,    required this.isDeleted } );
  ///
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EcmProductFieldsOneOf&&
    other.id == id&&
    other.name == name&&
  ...
  /// Returns a new [EcmProductFieldsOneOf] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EcmProductFieldsOneOf? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EcmProductFieldsOneOf[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EcmProductFieldsOneOf[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EcmProductFieldsOneOf(
        id: mapValueOfType<bool>(json, r'id'),
        name: mapValueOfType<bool>(json, r'name'),
        description: mapValueOfType<bool>(json, r'description'),
        sku: mapValueOfType<bool>(json, r'sku'),
        thumbnailImageURL: mapValueOfType<bool>(json, r'thumbnailImageURL'),
        imageURLs: mapValueOfType<bool>(json, r'imageURLs'),
        price: mapValueOfType<bool>(json, r'price'),
        manufacturer: mapValueOfType<bool>(json, r'manufacturer'),
        supplier: mapValueOfType<bool>(json, r'supplier'),
        stockQuantity: mapValueOfType<bool>(json, r'stockQuantity'),
  ...
  static List<EcmProductFieldsOneOf> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmProductFieldsOneOf>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EcmProductFieldsOneOf.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EcmProductFieldsOneOf> mapFromJson(dynamic json) {
    final map = <String, EcmProductFieldsOneOf>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EcmProductFieldsOneOf.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EcmProductFieldsOneOf-objects as value to a dart map
  static Map<String, List<EcmProductFieldsOneOf>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EcmProductFieldsOneOf>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EcmProductFieldsOneOf.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension EcmProductFieldsOneOfJsonUtils on EcmProductFieldsOneOf{
static List<EcmProductFieldsOneOf> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmProductFieldsOneOf>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
