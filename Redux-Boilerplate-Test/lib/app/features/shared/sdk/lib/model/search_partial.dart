...
class SearchPartial {
  SearchPartial(  {  required this.id,    required this.zipCode,    required this.distance,    required this.ageOfLearner,    required this.availabilityDate,    required this.createdDate,    required this.createdBy,    required this.createdById,     this.updatedDate,     this.updatedBy,     this.updatedById,     this.deletedDate,     this.deletedBy,     this.deletedById,    required this.isDeleted } );
  ///
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SearchPartial&&
    other.id == id&&
  ...
  /// Returns a new [SearchPartial] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SearchPartial? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SearchPartial[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SearchPartial[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<SearchPartial> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SearchPartial>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SearchPartial.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SearchPartial> mapFromJson(dynamic json) {
    final map = <String, SearchPartial>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SearchPartial.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SearchPartial-objects as value to a dart map
  static Map<String, List<SearchPartial>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SearchPartial>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SearchPartial.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension SearchPartialJsonUtils on SearchPartial{
static List<SearchPartial> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SearchPartial>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
