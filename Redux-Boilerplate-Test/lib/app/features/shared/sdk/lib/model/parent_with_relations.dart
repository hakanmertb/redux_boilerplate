...
class ParentWithRelations {
  ParentWithRelations(  {  required this.id,    required this.firstName,    required this.lastName,    required this.profileImageUrl,    required this.shortBio,    required this.longBio,    required this.email,    required this.mobilePhone,    required this.workPhone,    required this.supportedZipCodes,    required this.supportedAgeOfLearners,    required this.distance,    required this.hourlyRate,    required this.yearsOfExperience,    required this.teaches,    required this.specialties,    required this.createdDate,    required this.createdBy,    required this.createdById,     this.updatedDate,     this.updatedBy,     this.updatedById,     this.deletedDate,     this.deletedBy,     this.deletedById,    required this.isDeleted } );
  String id;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ParentWithRelations&&
    other.id == id&&
    ...
    _deepEquality.equals(other.supportedAgeOfLearners, supportedAgeOfLearners)&&
  ...
  /// Returns a new [ParentWithRelations] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ParentWithRelations? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ParentWithRelations[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ParentWithRelations[$key]" has a null value in JSON.');
        });
        return true;
      }());
      ...
      return ParentWithRelations(
        ...
        supportedAgeOfLearners: json[r'supportedAgeOfLearners'] is Iterable
            ? (json[r'supportedAgeOfLearners'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        distance: mapValueOfType<String>(json, r'distance'),
        hourlyRate: json[r'hourlyRate'] is Iterable
            ? (json[r'hourlyRate'] as Iterable).cast<num>().toList(growable: false)
            : const [],
        yearsOfExperience: ObjectJsonUtils.listFromJson(json[r'yearsOfExperience']),
        teaches: json[r'teaches'] is Iterable
            ? (json[r'teaches'] as Iterable).cast<String>().toList(growable: false)
            : const [],
        specialties: json[r'specialties'] is Iterable
            ? (json[r'specialties'] as Iterable).cast<String>().toList(growable: false)
            : const [],
  ...
  static List<ParentWithRelations> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ParentWithRelations>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ParentWithRelations.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ParentWithRelations> mapFromJson(dynamic json) {
    final map = <String, ParentWithRelations>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ParentWithRelations.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ParentWithRelations-objects as value to a dart map
  static Map<String, List<ParentWithRelations>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ParentWithRelations>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ParentWithRelations.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension ParentWithRelationsJsonUtils on ParentWithRelations{
static List<ParentWithRelations> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ParentWithRelations>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
