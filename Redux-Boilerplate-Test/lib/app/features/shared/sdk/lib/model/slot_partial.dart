...
extension SlotPartialJsonUtils on SlotPartial{
static List<SlotPartial> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SlotPartial>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
