...
class EcmAddressWithRelations {
  EcmAddressWithRelations(  {  required this.id,    required this.type,    required this.street1,    required this.street2,    required this.city,    required this.state,    required this.zipcode,    required this.country,    required this.contactPhone,    required this.fullName,    required this.userId,    required this.createdDate,    required this.createdBy,    required this.createdById,     this.updatedDate,     this.updatedBy,     this.updatedById,     this.deletedDate,     this.deletedBy,     this.deletedById,    required this.isDeleted } );
  String id;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EcmAddressWithRelations&&
    other.id == id&&
    other.type == type&&
  ...
  /// Returns a new [EcmAddressWithRelations] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EcmAddressWithRelations? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EcmAddressWithRelations[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EcmAddressWithRelations[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EcmAddressWithRelations(
  ...
  static List<EcmAddressWithRelations> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmAddressWithRelations>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EcmAddressWithRelations.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EcmAddressWithRelations> mapFromJson(dynamic json) {
    final map = <String, EcmAddressWithRelations>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EcmAddressWithRelations.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EcmAddressWithRelations-objects as value to a dart map
  static Map<String, List<EcmAddressWithRelations>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EcmAddressWithRelations>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EcmAddressWithRelations.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension EcmAddressWithRelationsJsonUtils on EcmAddressWithRelations{
static List<EcmAddressWithRelations> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmAddressWithRelations>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
