...
class ProviderFieldsOneOf {
  ProviderFieldsOneOf(  {  required this.id,    required this.firstName,    required this.lastName,    required this.profileImageUrl,    required this.shortBio,    required this.longBio,    required this.email,    required this.mobilePhone,    required this.workPhone,    required this.supportedZipCodes,    required this.supportedAgeOfLearners,    required this.distance,    required this.hourlyRate,    required this.yearsOfExperience,    required this.teaches,    required this.specialties,    required this.acceptingStudents,    required this.createdDate,    required this.createdBy,    required this.createdById,    required this.updatedDate,    required this.updatedBy,    required this.updatedById,    required this.deletedDate,    required this.deletedBy,    required this.deletedById,    required this.isDeleted } );
  ///
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ProviderFieldsOneOf&&
    other.id == id&&
  ...
  /// Returns a new [ProviderFieldsOneOf] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ProviderFieldsOneOf? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ProviderFieldsOneOf[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ProviderFieldsOneOf[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ProviderFieldsOneOf(
  ...
  static List<ProviderFieldsOneOf> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ProviderFieldsOneOf>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ProviderFieldsOneOf.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ProviderFieldsOneOf> mapFromJson(dynamic json) {
    final map = <String, ProviderFieldsOneOf>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ProviderFieldsOneOf.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ProviderFieldsOneOf-objects as value to a dart map
  static Map<String, List<ProviderFieldsOneOf>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ProviderFieldsOneOf>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ProviderFieldsOneOf.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension ProviderFieldsOneOfJsonUtils on ProviderFieldsOneOf{
static List<ProviderFieldsOneOf> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ProviderFieldsOneOf>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
