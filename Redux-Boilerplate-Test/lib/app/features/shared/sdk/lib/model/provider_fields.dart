...
class ProviderFields {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ProviderFields&&
    other.id == id&&
  ...
  /// Returns a new [ProviderFields] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ProviderFields? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ProviderFields[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ProviderFields[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ProviderFields> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ProviderFields>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ProviderFields.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ProviderFields> mapFromJson(dynamic json) {
    final map = <String, ProviderFields>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ProviderFields.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ProviderFields-objects as value to a dart map
  static Map<String, List<ProviderFields>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ProviderFields>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ProviderFields.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension ProviderFieldsJsonUtils on ProviderFields{
static List<ProviderFields> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ProviderFields>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
