...
class ProviderPartial {
  ProviderPartial(  {  required this.id,    required this.firstName,    required this.lastName,    required this.profileImageUrl,    required this.shortBio,    required this.longBio,    required this.email,    required this.mobilePhone,    required this.workPhone,    required this.supportedZipCodes,    required this.supportedAgeOfLearners,    required this.distance,    required this.hourlyRate,    required this.yearsOfExperience,    required this.teaches,    required this.specialties,    required this.acceptingStudents,    required this.createdDate,    required this.createdBy,    required this.createdById,     this.updatedDate,     this.updatedBy,     this.updatedById,     this.deletedDate,     this.deletedBy,     this.deletedById,    required this.isDeleted } );
  ///
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ProviderPartial&&
    other.id == id&&
  ...
  /// Returns a new [ProviderPartial] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ProviderPartial? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ProviderPartial[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ProviderPartial[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ProviderPartial> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ProviderPartial>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ProviderPartial.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ProviderPartial> mapFromJson(dynamic json) {
    final map = <String, ProviderPartial>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ProviderPartial.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ProviderPartial-objects as value to a dart map
  static Map<String, List<ProviderPartial>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ProviderPartial>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ProviderPartial.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension ProviderPartialJsonUtils on ProviderPartial{
static List<ProviderPartial> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ProviderPartial>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
