...
extension ParentJsonUtils on Parent{
static List<Parent> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Parent>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
