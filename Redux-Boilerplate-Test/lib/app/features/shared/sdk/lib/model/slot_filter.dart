...
class SlotFilter {
  SlotFilter(  {  required this.offset,    required this.limit,    required this.skip,    required this.order,    required this.where,    required this.fields,    required this.include } );
  ///
...
extension SlotFilterJsonUtils on SlotFilter{
static List<SlotFilter> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SlotFilter>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
