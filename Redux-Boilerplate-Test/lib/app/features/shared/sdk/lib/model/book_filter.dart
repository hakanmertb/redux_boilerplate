...
class BookFilter {
  BookFilter(  {  required this.offset,    required this.limit,    required this.skip,    required this.order,    required this.fields,    required this.include } );
  ///
...
extension BookFilterJsonUtils on BookFilter{
static List<BookFilter> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <BookFilter>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
