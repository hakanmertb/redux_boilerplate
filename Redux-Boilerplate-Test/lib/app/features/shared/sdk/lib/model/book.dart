...
class Book {
  Book(  {  required this.id,    required this.providerId,    required this.createdDate,    required this.createdBy,    required this.createdById,     this.updatedDate,     this.updatedBy,     this.updatedById,     this.deletedDate,     this.deletedBy,     this.deletedById,    required this.isDeleted,    required this.userId } );
  String id;
  ...
  @override
  String toString() => 'Book[id=$id, providerId=$providerId, createdDate=$createdDate, createdBy=$createdBy, createdById=$createdById, updatedDate=$updatedDate, updatedBy=$updatedBy, updatedById=$updatedById, deletedDate=$deletedDate, deletedBy=$deletedBy, deletedById=$deletedById, isDeleted=$isDeleted, userId=$userId]';
...
extension BookJsonUtils on Book{
static List<Book> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <Book>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
