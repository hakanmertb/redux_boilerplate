...
class EcmProductFields {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EcmProductFields&&
    other.id == id&&
    other.name == name&&
  ...
  /// Returns a new [EcmProductFields] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EcmProductFields? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EcmProductFields[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EcmProductFields[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EcmProductFields(
  ...
  static List<EcmProductFields> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmProductFields>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EcmProductFields.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EcmProductFields> mapFromJson(dynamic json) {
    final map = <String, EcmProductFields>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EcmProductFields.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EcmProductFields-objects as value to a dart map
  static Map<String, List<EcmProductFields>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EcmProductFields>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EcmProductFields.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension EcmProductFieldsJsonUtils on EcmProductFields{
static List<EcmProductFields> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmProductFields>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
