...
extension NewEcmAddressJsonUtils on NewEcmAddress{
static List<NewEcmAddress> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NewEcmAddress>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
