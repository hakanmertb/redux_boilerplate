...
extension NewEcmProductJsonUtils on NewEcmProduct{
static List<NewEcmProduct> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NewEcmProduct>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
