...
class ParentPartial {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ParentPartial&&
    other.id == id&&
  ...
  /// Returns a new [ParentPartial] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ParentPartial? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ParentPartial[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ParentPartial[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<ParentPartial> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ParentPartial>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ParentPartial.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ParentPartial> mapFromJson(dynamic json) {
    final map = <String, ParentPartial>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ParentPartial.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ParentPartial-objects as value to a dart map
  static Map<String, List<ParentPartial>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ParentPartial>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ParentPartial.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension ParentPartialJsonUtils on ParentPartial{
static List<ParentPartial> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ParentPartial>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
