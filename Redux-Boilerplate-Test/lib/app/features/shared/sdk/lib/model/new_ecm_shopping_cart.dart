...
class NewEcmShoppingCart {
  NewEcmShoppingCart(  {  required this.isActive,    required this.userId,    required this.createdDate,    required this.createdBy,    required this.createdById,     this.updatedDate,     this.updatedBy,     this.updatedById,     this.deletedDate,     this.deletedBy,     this.deletedById,    required this.isDeleted } );
  ///
  ...
  @override
  String toString() => 'NewEcmShoppingCart[isActive=$isActive, userId=$userId, createdDate=$createdDate, createdBy=$createdBy, createdById=$createdById, updatedDate=$updatedDate, updatedBy=$updatedBy, updatedById=$updatedById, deletedDate=$deletedDate, deletedBy=$deletedBy, deletedById=$deletedById, isDeleted=$isDeleted]';
...
extension NewEcmShoppingCartJsonUtils on NewEcmShoppingCart{
static List<NewEcmShoppingCart> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NewEcmShoppingCart>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
