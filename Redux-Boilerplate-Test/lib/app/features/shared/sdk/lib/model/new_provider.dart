...
class NewProvider {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is NewProvider&&
  ...
  /// Returns a new [NewProvider] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static NewProvider? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "NewProvider[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "NewProvider[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<NewProvider> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NewProvider>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = NewProvider.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, NewProvider> mapFromJson(dynamic json) {
    final map = <String, NewProvider>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = NewProvider.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of NewProvider-objects as value to a dart map
  static Map<String, List<NewProvider>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<NewProvider>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = NewProvider.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension NewProviderJsonUtils on NewProvider{
static List<NewProvider> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NewProvider>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
