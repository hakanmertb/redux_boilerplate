...
class ProductFilter {
  ProductFilter(  {  required this.offset,    required this.limit,    required this.skip,    required this.order,    required this.fields } );
  ///
  ...
  @override
  String toString() => 'ProductFilter[offset=$offset, limit=$limit, skip=$skip, order=$order, fields=$fields]';
...
extension ProductFilterJsonUtils on ProductFilter{
static List<ProductFilter> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ProductFilter>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
