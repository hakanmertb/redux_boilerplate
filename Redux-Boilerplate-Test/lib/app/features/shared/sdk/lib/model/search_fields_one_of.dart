...
class SearchFieldsOneOf {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is SearchFieldsOneOf&&
    other.id == id&&
  ...
  /// Returns a new [SearchFieldsOneOf] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static SearchFieldsOneOf? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "SearchFieldsOneOf[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "SearchFieldsOneOf[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return SearchFieldsOneOf(
        id: mapValueOfType<bool>(json, r'id'),
        zipCode: mapValueOfType<bool>(json, r'zipCode'),
        distance: mapValueOfType<bool>(json, r'distance'),
        ageOfLearner: mapValueOfType<bool>(json, r'ageOfLearner'),
        availabilityDate: mapValueOfType<bool>(json, r'availabilityDate'),
  ...
  static List<SearchFieldsOneOf> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SearchFieldsOneOf>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = SearchFieldsOneOf.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, SearchFieldsOneOf> mapFromJson(dynamic json) {
    final map = <String, SearchFieldsOneOf>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = SearchFieldsOneOf.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of SearchFieldsOneOf-objects as value to a dart map
  static Map<String, List<SearchFieldsOneOf>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<SearchFieldsOneOf>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = SearchFieldsOneOf.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension SearchFieldsOneOfJsonUtils on SearchFieldsOneOf{
static List<SearchFieldsOneOf> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <SearchFieldsOneOf>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
