...
class ParentFieldsOneOf {
  ParentFieldsOneOf(  {  required this.id,    required this.firstName,    required this.lastName,    required this.profileImageUrl,    required this.shortBio,    required this.longBio,    required this.email,    required this.mobilePhone,    required this.workPhone,    required this.supportedZipCodes,    required this.supportedAgeOfLearners,    required this.distance,    required this.hourlyRate,    required this.yearsOfExperience,    required this.teaches,    required this.specialties,    required this.createdDate,    required this.createdBy,    required this.createdById,    required this.updatedDate,    required this.updatedBy,    required this.updatedById,    required this.deletedDate,    required this.deletedBy,    required this.deletedById,    required this.isDeleted } );
  ///
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ParentFieldsOneOf&&
    other.id == id&&
  ...
  int get hashCode => 
    ...
    (supportedAgeOfLearners == null ? 0 : supportedAgeOfLearners!.hashCode) +
    (distance == null ? 0 : distance!.hashCode) +
    (hourlyRate == null ? 0 : hourlyRate!.hashCode) +
    (yearsOfExperience == null ? 0 : yearsOfExperience!.hashCode) +
    (teaches == null ? 0 : teaches!.hashCode) +
  ...
  Map<String, dynamic> toJson() {
    ...
    if (this.supportedAgeOfLearners != null) {
      json[r'supportedAgeOfLearners'] = this.supportedAgeOfLearners;
    } else {
      json[r'supportedAgeOfLearners'] = null;
    }
  ...
  /// Returns a new [ParentFieldsOneOf] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ParentFieldsOneOf? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ParentFieldsOneOf[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ParentFieldsOneOf[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ParentFieldsOneOf(
        id: mapValueOfType<bool>(json, r'id'),
        firstName: mapValueOfType<bool>(json, r'firstName'),
        lastName: mapValueOfType<bool>(json, r'lastName'),
        profileImageUrl: mapValueOfType<bool>(json, r'profileImageUrl'),
        shortBio: mapValueOfType<bool>(json, r'shortBio'),
        longBio: mapValueOfType<bool>(json, r'longBio'),
        email: mapValueOfType<bool>(json, r'email'),
        mobilePhone: mapValueOfType<bool>(json, r'mobilePhone'),
        workPhone: mapValueOfType<bool>(json, r'workPhone'),
        supportedZipCodes: mapValueOfType<bool>(json, r'supportedZipCodes'),
        supportedAgeOfLearners: mapValueOfType<bool>(json, r'supportedAgeOfLearners'),
        distance: mapValueOfType<bool>(json, r'distance'),
        hourlyRate: mapValueOfType<bool>(json, r'hourlyRate'),
        yearsOfExperience: mapValueOfType<bool>(json, r'yearsOfExperience'),
        teaches: mapValueOfType<bool>(json, r'teaches'),
        specialties: mapValueOfType<bool>(json, r'specialties'),
  ...
  static List<ParentFieldsOneOf> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ParentFieldsOneOf>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ParentFieldsOneOf.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ParentFieldsOneOf> mapFromJson(dynamic json) {
    final map = <String, ParentFieldsOneOf>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ParentFieldsOneOf.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ParentFieldsOneOf-objects as value to a dart map
  static Map<String, List<ParentFieldsOneOf>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ParentFieldsOneOf>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ParentFieldsOneOf.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension ParentFieldsOneOfJsonUtils on ParentFieldsOneOf{
static List<ParentFieldsOneOf> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ParentFieldsOneOf>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
