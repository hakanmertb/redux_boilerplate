...
class EcmTransactionWithRelations {
  ...
  @override
  String toString() => 'EcmTransactionWithRelations[id=$id, userId=$userId, provider=$provider, amount=$amount, currency=$currency, description=$description, paymentDate=$paymentDate, createdDate=$createdDate, createdBy=$createdBy, createdById=$createdById, updatedDate=$updatedDate, updatedBy=$updatedBy, updatedById=$updatedById, deletedDate=$deletedDate, deletedBy=$deletedBy, deletedById=$deletedById, isDeleted=$isDeleted, orderId=$orderId, order=$order]';
...
extension EcmTransactionWithRelationsJsonUtils on EcmTransactionWithRelations{
static List<EcmTransactionWithRelations> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmTransactionWithRelations>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
