...
class User {
  User(  {  required this.id,    required this.username,    required this.password,     this.firstName,     this.middleName,     this.lastName,    required this.email,     this.phoneNumber,     this.avatar,    required this.createdDate,    required this.createdBy,    required this.createdById,     this.updatedDate,     this.updatedBy,     this.updatedById,     this.deletedDate,     this.deletedBy,     this.deletedById,    required this.isDeleted } );
  ///
...
extension UserJsonUtils on User{
static List<User> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <User>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
