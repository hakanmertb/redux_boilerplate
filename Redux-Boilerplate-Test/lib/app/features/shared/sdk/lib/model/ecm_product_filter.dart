...
class EcmProductFilter {
  EcmProductFilter(  {  required this.offset,    required this.limit,    required this.skip,    required this.order,    required this.fields } );
  ///
...
extension EcmProductFilterJsonUtils on EcmProductFilter{
static List<EcmProductFilter> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmProductFilter>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
