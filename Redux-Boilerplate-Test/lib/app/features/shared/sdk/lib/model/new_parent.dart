...
class NewParent {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is NewParent&&
  ...
  /// Returns a new [NewParent] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static NewParent? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "NewParent[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "NewParent[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<NewParent> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NewParent>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = NewParent.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, NewParent> mapFromJson(dynamic json) {
    final map = <String, NewParent>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = NewParent.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of NewParent-objects as value to a dart map
  static Map<String, List<NewParent>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<NewParent>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = NewParent.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension NewParentJsonUtils on NewParent{
static List<NewParent> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NewParent>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
