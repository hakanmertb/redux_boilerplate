...
class EcmOrderFields {
  EcmOrderFields(  {  required this.id,    required this.userId,    required this.status,    required this.totalPrice,    required this.paymentStatus,    required this.currency,    required this.shippingAddress,    required this.billingAddress,    required this.paymentDate,    required this.createdDate,    required this.createdBy,    required this.createdById,    required this.updatedDate,    required this.updatedBy,    required this.updatedById,    required this.deletedDate,    required this.deletedBy,    required this.deletedById,    required this.isDeleted,    required this.shoppingCartId } );
  ///
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EcmOrderFields&&
    other.id == id&&
    other.userId == userId&&
    other.status == status&&
  ...
  /// Returns a new [EcmOrderFields] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EcmOrderFields? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EcmOrderFields[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EcmOrderFields[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EcmOrderFields(
        id: mapValueOfType<bool>(json, r'id'),
        userId: mapValueOfType<bool>(json, r'userId'),
        status: mapValueOfType<bool>(json, r'status'),
        totalPrice: mapValueOfType<bool>(json, r'totalPrice'),
        paymentStatus: mapValueOfType<bool>(json, r'paymentStatus'),
        currency: mapValueOfType<bool>(json, r'currency'),
        shippingAddress: mapValueOfType<bool>(json, r'shippingAddress'),
        billingAddress: mapValueOfType<bool>(json, r'billingAddress'),
  ...
  static List<EcmOrderFields> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmOrderFields>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EcmOrderFields.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EcmOrderFields> mapFromJson(dynamic json) {
    final map = <String, EcmOrderFields>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EcmOrderFields.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EcmOrderFields-objects as value to a dart map
  static Map<String, List<EcmOrderFields>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EcmOrderFields>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EcmOrderFields.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension EcmOrderFieldsJsonUtils on EcmOrderFields{
static List<EcmOrderFields> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmOrderFields>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
