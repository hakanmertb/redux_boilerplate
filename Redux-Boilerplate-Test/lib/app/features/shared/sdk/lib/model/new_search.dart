...
class NewSearch {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is NewSearch&&
  ...
  /// Returns a new [NewSearch] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static NewSearch? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "NewSearch[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "NewSearch[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<NewSearch> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NewSearch>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = NewSearch.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, NewSearch> mapFromJson(dynamic json) {
    final map = <String, NewSearch>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = NewSearch.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of NewSearch-objects as value to a dart map
  static Map<String, List<NewSearch>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<NewSearch>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = NewSearch.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension NewSearchJsonUtils on NewSearch{
static List<NewSearch> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <NewSearch>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
