...
class EcmProductPartial {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EcmProductPartial&&
    other.id == id&&
    other.name == name&&
  ...
  /// Returns a new [EcmProductPartial] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EcmProductPartial? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EcmProductPartial[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EcmProductPartial[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EcmProductPartial(
  ...
  static List<EcmProductPartial> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmProductPartial>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EcmProductPartial.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EcmProductPartial> mapFromJson(dynamic json) {
    final map = <String, EcmProductPartial>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EcmProductPartial.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EcmProductPartial-objects as value to a dart map
  static Map<String, List<EcmProductPartial>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EcmProductPartial>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EcmProductPartial.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension EcmProductPartialJsonUtils on EcmProductPartial{
static List<EcmProductPartial> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmProductPartial>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
