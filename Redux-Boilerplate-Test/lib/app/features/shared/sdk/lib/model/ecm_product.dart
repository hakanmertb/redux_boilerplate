...
class EcmProduct {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EcmProduct&&
    other.id == id&&
    other.name == name&&
  ...
  /// Returns a new [EcmProduct] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EcmProduct? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EcmProduct[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EcmProduct[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<EcmProduct> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmProduct>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EcmProduct.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EcmProduct> mapFromJson(dynamic json) {
    final map = <String, EcmProduct>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EcmProduct.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EcmProduct-objects as value to a dart map
  static Map<String, List<EcmProduct>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EcmProduct>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EcmProduct.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension EcmProductJsonUtils on EcmProduct{
static List<EcmProduct> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmProduct>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
