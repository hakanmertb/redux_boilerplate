...
class EcmDiscountPartial {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EcmDiscountPartial&&
    other.id == id&&
  ...
  /// Returns a new [EcmDiscountPartial] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EcmDiscountPartial? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EcmDiscountPartial[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EcmDiscountPartial[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return EcmDiscountPartial(
  ...
  static List<EcmDiscountPartial> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmDiscountPartial>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EcmDiscountPartial.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EcmDiscountPartial> mapFromJson(dynamic json) {
    final map = <String, EcmDiscountPartial>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EcmDiscountPartial.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EcmDiscountPartial-objects as value to a dart map
  static Map<String, List<EcmDiscountPartial>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EcmDiscountPartial>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EcmDiscountPartial.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension EcmDiscountPartialJsonUtils on EcmDiscountPartial{
static List<EcmDiscountPartial> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmDiscountPartial>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
