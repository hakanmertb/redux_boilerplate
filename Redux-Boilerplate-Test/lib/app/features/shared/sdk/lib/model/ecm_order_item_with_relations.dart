...
class EcmOrderItemWithRelations {
  EcmOrderItemWithRelations(  {  required this.id,    required this.quantity,    required this.priceAtOrder,    required this.createdDate,    required this.createdBy,    required this.createdById,     this.updatedDate,     this.updatedBy,     this.updatedById,     this.deletedDate,     this.deletedBy,     this.deletedById,    required this.isDeleted,    required this.productId,    required this.orderId,    required this.product,    required this.order } );
  String id;
...
extension EcmOrderItemWithRelationsJsonUtils on EcmOrderItemWithRelations{
static List<EcmOrderItemWithRelations> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmOrderItemWithRelations>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
