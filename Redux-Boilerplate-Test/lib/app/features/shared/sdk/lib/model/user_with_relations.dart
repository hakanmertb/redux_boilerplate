...
class UserWithRelations {
  UserWithRelations(  {  required this.id,    required this.username,    required this.password,     this.firstName,     this.middleName,     this.lastName,    required this.email,     this.phoneNumber,     this.avatar,    required this.createdDate,    required this.createdBy,    required this.createdById,     this.updatedDate,     this.updatedBy,     this.updatedById,     this.deletedDate,     this.deletedBy,     this.deletedById,    required this.isDeleted,    required this.books } );
  ///
  ...
  static UserWithRelations? fromJson(dynamic value) {
    if (value is Map) {
      ...
      return UserWithRelations(
        ...
        books: BookWithRelationsJsonUtils.listFromJson(json[r'books']),
      );
    }
    return null;
  }
