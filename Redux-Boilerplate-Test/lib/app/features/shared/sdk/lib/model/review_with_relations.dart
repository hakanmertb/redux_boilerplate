...
class ReviewWithRelations {
  ReviewWithRelations(  {  required this.id,    required this.rate,    required this.review,    required this.likeCount,    required this.dislikeCount,    required this.replyText,    required this.email,    required this.name,    required this.parentId,    required this.createdDate,    required this.createdBy,    required this.createdById,     this.updatedDate,     this.updatedBy,     this.updatedById,     this.deletedDate,     this.deletedBy,     this.deletedById,    required this.isDeleted,    required this.providerId,    required this.userId,    required this.provider,    required this.user } );
  String id;
...
extension ReviewWithRelationsJsonUtils on ReviewWithRelations{
static List<ReviewWithRelations> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ReviewWithRelations>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
