...
class EcmOrder {
  EcmOrder(  {  required this.id,    required this.userId,    required this.status,    required this.totalPrice,    required this.paymentStatus,    required this.currency,    required this.shippingAddress,    required this.billingAddress,     this.paymentDate,    required this.createdDate,    required this.createdBy,    required this.createdById,     this.updatedDate,     this.updatedBy,     this.updatedById,     this.deletedDate,     this.deletedBy,     this.deletedById,    required this.isDeleted,    required this.shoppingCartId } );
  String id;
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is EcmOrder&&
    other.id == id&&
    other.userId == userId&&
    other.status == status&&
  ...
  /// Returns a new [EcmOrder] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static EcmOrder? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "EcmOrder[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "EcmOrder[$key]" has a null value in JSON.');
        });
        return true;
      }());
  ...
  static List<EcmOrder> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmOrder>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = EcmOrder.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, EcmOrder> mapFromJson(dynamic json) {
    final map = <String, EcmOrder>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = EcmOrder.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of EcmOrder-objects as value to a dart map
  static Map<String, List<EcmOrder>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<EcmOrder>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = EcmOrder.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension EcmOrderJsonUtils on EcmOrder{
static List<EcmOrder> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <EcmOrder>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
