...
extension MapJsonUtils<K, V> on Map<K, V> {
  static List<Map<String, Object>> listFromJson(dynamic json,{bool growable = false,}) {
    final result = <Map<String, Object>>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        if(row is Map){
          var value = row.cast<String, Object>();
          result.add(value);
        }
      }
    }
...
extension ObjectJsonUtils on Object {
  static List<Object> listFromJson(dynamic json,{bool growable = false,}) {
    final result = <Object>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = row as Object;
         result.add(value);
      }
    }
    return result.toList(growable: growable);
