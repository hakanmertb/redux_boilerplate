...
class ApplicationPartial {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ApplicationPartial&&
    other.id == id&&
    other.type == type&&
  ...
  @override
  String toString() => 'ApplicationPartial[id=$id, type=$type, zipcode=$zipcode, gender=$gender, birthday=$birthday, heightFeet=$heightFeet, heightInch=$heightInch, weight=$weight, householdSize=$householdSize, qualifyingLifeEvent=$qualifyingLifeEvent, smoking=$smoking, houseHoldIncomeRange=$houseHoldIncomeRange, healthConditions=$healthConditions, pregnancy=$pregnancy, sampleFieldName=$sampleFieldName, createdDate=$createdDate, createdBy=$createdBy, createdById=$createdById, updatedDate=$updatedDate, updatedBy=$updatedBy, updatedById=$updatedById, deletedDate=$deletedDate, deletedBy=$deletedBy, deletedById=$deletedById, isDeleted=$isDeleted]';
  ...
  /// Returns a new [ApplicationPartial] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ApplicationPartial? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ApplicationPartial[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ApplicationPartial[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ApplicationPartial(
  ...
  static List<ApplicationPartial> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ApplicationPartial>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApplicationPartial.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ApplicationPartial> mapFromJson(dynamic json) {
    final map = <String, ApplicationPartial>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ApplicationPartial.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ApplicationPartial-objects as value to a dart map
  static Map<String, List<ApplicationPartial>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ApplicationPartial>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ApplicationPartial.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension ApplicationPartialJsonUtils on ApplicationPartial{
static List<ApplicationPartial> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ApplicationPartial>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
