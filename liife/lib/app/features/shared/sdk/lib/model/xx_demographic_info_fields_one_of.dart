...
class XxDemographicInfoFieldsOneOf {
  XxDemographicInfoFieldsOneOf(  {  required this.id,    required this.firstName,    required this.createdDate,    required this.createdBy,    required this.createdById,    required this.updatedDate,    required this.updatedBy,    required this.updatedById,    required this.deletedDate,    required this.deletedBy,    required this.deletedById,    required this.isDeleted } );
  ///
