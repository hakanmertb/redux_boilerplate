...
class ApplicationFieldsOneOf {
  ...
  @override
  bool operator ==(Object other) => identical(this, other) || other is ApplicationFieldsOneOf&&
    other.id == id&&
    other.type == type&&
    ...
    other.healthConditions == healthConditions&&
  ...
  int get hashCode => 
    ...
    (heightFeet == null ? 0 : heightFeet!.hashCode) +
    (heightInch == null ? 0 : heightInch!.hashCode) +
    (weight == null ? 0 : weight!.hashCode) +
    (householdSize == null ? 0 : householdSize!.hashCode) +
    (qualifyingLifeEvent == null ? 0 : qualifyingLifeEvent!.hashCode) +
    (smoking == null ? 0 : smoking!.hashCode) +
    (houseHoldIncomeRange == null ? 0 : houseHoldIncomeRange!.hashCode) +
    (healthConditions == null ? 0 : healthConditions!.hashCode) +
  ...
  /// Returns a new [ApplicationFieldsOneOf] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ApplicationFieldsOneOf? fromJson(dynamic value) {
    if (value is Map) {
      ...
      assert(() {
        requiredKeys.forEach((key) {
          assert(json.containsKey(key), 'Required key "ApplicationFieldsOneOf[$key]" is missing from JSON.');
          assert(json[key] != null, 'Required key "ApplicationFieldsOneOf[$key]" has a null value in JSON.');
        });
        return true;
      }());

      return ApplicationFieldsOneOf(
        id: mapValueOfType<bool>(json, r'id'),
        type: mapValueOfType<bool>(json, r'type'),
        zipcode: mapValueOfType<bool>(json, r'zipcode'),
        gender: mapValueOfType<bool>(json, r'gender'),
        birthday: mapValueOfType<bool>(json, r'birthday'),
        heightFeet: mapValueOfType<bool>(json, r'heightFeet'),
        heightInch: mapValueOfType<bool>(json, r'heightInch'),
        weight: mapValueOfType<bool>(json, r'weight'),
        householdSize: mapValueOfType<bool>(json, r'householdSize'),
        qualifyingLifeEvent: mapValueOfType<bool>(json, r'qualifyingLifeEvent'),
        smoking: mapValueOfType<bool>(json, r'smoking'),
        houseHoldIncomeRange: mapValueOfType<bool>(json, r'houseHoldIncomeRange'),
        healthConditions: mapValueOfType<bool>(json, r'healthConditions'),
        pregnancy: mapValueOfType<bool>(json, r'pregnancy'),
        sampleFieldName: mapValueOfType<bool>(json, r'sampleFieldName'),
  ...
  static List<ApplicationFieldsOneOf> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ApplicationFieldsOneOf>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApplicationFieldsOneOf.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ApplicationFieldsOneOf> mapFromJson(dynamic json) {
    final map = <String, ApplicationFieldsOneOf>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ApplicationFieldsOneOf.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
  ...
  // maps a json object with a list of ApplicationFieldsOneOf-objects as value to a dart map
  static Map<String, List<ApplicationFieldsOneOf>> mapListFromJson(dynamic json, {bool growable = false,}) {
    final map = <String, List<ApplicationFieldsOneOf>>{};
    if (json is Map && json.isNotEmpty) {
      // ignore: parameter_assignments
      json = json.cast<String, dynamic>();
      for (final entry in json.entries) {
        map[entry.key] = ApplicationFieldsOneOf.listFromJson(entry.value, growable: growable,);
      }
    }
    return map;
  }
...
extension ApplicationFieldsOneOfJsonUtils on ApplicationFieldsOneOf{
static List<ApplicationFieldsOneOf> listFromJson(dynamic json, {bool growable = false,}) {
    final result = <ApplicationFieldsOneOf>[];
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
