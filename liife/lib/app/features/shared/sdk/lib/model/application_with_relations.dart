...
class ApplicationWithRelations {
  ...
  /// Returns a new [ApplicationWithRelations] instance and imports its values from
  /// [value] if it's a [Map], null otherwise.
  // ignore: prefer_constructors_over_static_methods
  static ApplicationWithRelations? fromJson(dynamic value) {
    if (value is Map) {
  ...
  static List<ApplicationWithRelations> listFromJson(
    ...
    if (json is List && json.isNotEmpty) {
      for (final row in json) {
        final value = ApplicationWithRelations.fromJson(row);
        if (value != null) {
          result.add(value);
        }
      }
  ...
  static Map<String, ApplicationWithRelations> mapFromJson(dynamic json) {
    final map = <String, ApplicationWithRelations>{};
    if (json is Map && json.isNotEmpty) {
      json = json.cast<String, dynamic>(); // ignore: parameter_assignments
      for (final entry in json.entries) {
        final value = ApplicationWithRelations.fromJson(entry.value);
        if (value != null) {
          map[entry.key] = value;
        }
      }
